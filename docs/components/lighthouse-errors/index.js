class LighthouseErrors extends HTMLElement{
  constructor(){
    super();
  }
  ...
  get bodyBlock(){
    ...
    table.setAttribute('id', 'lighthouseErrorsTable');
    ...
    summary.setAttribute('id', 'lighthouseErrorsSummary');
...
window.customElements.define('lighthouse-errors', LighthouseErrors);